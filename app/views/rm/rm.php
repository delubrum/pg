<div @click.outside="showModal = false" class="w-[95%] sm:w-[90%] bg-white p-4 rounded-lg shadow-lg relative z-50">
    ...
    <h1 class="text-lg font-semibold mb-4 text-teal-700"><i class="ri-file-add-line text-3xl"></i> Terminar RM</h1>
    <form id="newForm" 
    ...
    <?php echo isset($id) ? "<input type='hidden' name='id' value='$id->id'>" : '' ?>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div>
            ...
            <input  type="number" step="1"  id="toreturn" name="toreturn" class="w-full p-1.5 border border-gray-300 rounded-md focus:ring focus:ring-teal-700 focus:outline-none" required>
        </div>

        <div>
            <label for="surplus" class="block text-gray-600 text-sm mb-1">Excedente</label>
            <input  type="number" step="1"  id="surplus" name="surplus" class="w-full p-1.5 border border-gray-300 rounded-md focus:ring focus:ring-teal-700 focus:outline-none" required>
        </div>
