    ...
    >
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div x-show="selectedOption === 'Cliente'">
              ...
              <input id="phone" name="phone" class="w-full p-1.5 border border-gray-300 rounded-md focus:ring focus:ring-teal-700 focus:outline-none" :required="selectedOption === 'Cliente'">
          </div>
          <div x-show="selectedOption === 'Cliente'">
        ...
        <div class="pt-4 grid grid-cols-1 sm:grid-cols-1 gap-4" x-show="selectedOption === 'Cliente'">
          <div>
